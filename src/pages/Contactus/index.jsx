...
const Contact = () => {
  ...
  return (
    <div className="w-full bg-global-1 overflow-x-hidden flex flex-col items-center">
      ...
      >
        <div className="relative w-full max-w-[1440px] mx-auto px-4 md:px-16">
          ...
          <div className="relative z-10 w-full">
            <div className="flex flex-col md:flex-row items-end justify-between w-full gap-8 pt-14 md:pt-20">
              <div className="text-[#f0f0f0] text-3xl sm:text-5xl md:text-[73px] font-semibold leading-none">
                ...
                <p className="block text-base sm:text-lg md:text-[18px] font-normal text-[#c0c0bf] mt-4 leading-[1.6]">
      ...
      {/* Contact Section */}
      <section className="w-full max-w-[1440px] mx-auto px-4 md:px-16 py-10 md:py-16 flex flex-col md:flex-row gap-10 md:gap-12">
        {/* Left Column */}
        <div className="w-full md:w-1/3 flex flex-col gap-10">
          <div>
            <h2 className="text-xl sm:text-2xl font-bold text-[#f0f0f0] mb-4">Get in Touch</h2>
            <div className="flex flex-col gap-3">
              <button className="bg-[#161514] text-[#f0f0f0] rounded-lg px-4 py-3 text-left w-full">
          ...
          <div>
            <h2 className="text-xl sm:text-2xl font-bold text-[#f0f0f0] mb-2">Our Office</h2>
            <div className="mb-3 text-[#c0c0bf]">Address: 123 Main St, Anytown, USA 12345</div>
            <button className="bg-[#282726] text-[#f0f0f0] rounded-lg px-4 py-2 w-full sm:w-auto">
              Get Directions
            </button>
          </div>
          <div>
            <h2 className="text-xl sm:text-2xl font-bold text-[#f0f0f0] mb-2">Connect with us</h2>
        ...
        {/* Right Column */}
        <div className="w-full md:w-2/3 bg-global-1 rounded-2xl p-6 sm:p-8 flex flex-col gap-6">
          <h2 className="text-2xl sm:text-3xl font-bold text-[#f0f0f0] mb-2">Have a project in your mind?</h2>
          <form className="flex flex-col gap-4" onSubmit={handleSubmit}>
            <div className="flex flex-col md:flex-row gap-4">
              <input
                ...
                placeholder="Name"
                className="flex-1 px-4 py-3 rounded bg-[#282726] text-[#f0f0f0] border border-[#282726] focus:outline-none"
                required
              />
              <input
                type="text"
            ...
            <textarea
              ...
              placeholder="Message"
              rows={5}
              className="w-full px-4 py-3 rounded bg-[#282726] text-[#f0f0f0] border border-[#282726] focus:outline-none"
              required
            />
            <div className="flex items-center gap-2">
              <input type="checkbox" id="terms" className="accent-[#ffb877]" required />
            ...
            <button
              type="submit"
              className="self-end bg-global-4 hover:bg-[#ff9248] text-[#ffff] font-semibold py-3 px-8 rounded-lg flex items-center gap-2 transition-colors"
            >
              Send <span><i className="fas fa-paper-plane"></i></span>
            </button>
            {submitted && (
              <div className="text-green-400 text-lg font-semibold text-center py-4">
      ...
      {/* FAQ Section */}
      <section className="w-full bg-global-1 py-10 md:py-20 px-4 md:px-16">
        <div className="max-w-[1440px] mx-auto">
          <div className="flex items-center mb-8 md:mb-10">
            <img src="/images/img_vector.svg" alt="FAQ Icon" className="w-8 h-8 md:w-10 md:h-10 mr-4" />
            <h2 className="text-2xl sm:text-4xl md:text-6xl font-clash-display font-semibold text-[#f0f0f0]">
              Frequently Asked Questions
            </h2>
          </div>
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6 md:gap-8">
            <div className="border border-[#282726] rounded-xl p-6 md:p-8">
              <h3 className="text-xl md:text-2xl font-semibold text-[#f0f0f0] mb-3">
